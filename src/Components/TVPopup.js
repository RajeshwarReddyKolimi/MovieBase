...
export default function TVPopup(props) {
    ...
    async function getStreamer(e) {
        try {
            const response = await fetch(
                `https://api.themoviedb.org/3/tv/${details.id}/watch/providers`,
                options
            );
    ...
    async function getSimilar(e) {
        try {
            const response = await fetch(
                `https://api.themoviedb.org/3/tv/${details.id}/similar?limit=5`,
                options
            );
            const data = await response.json();
        ...
        >
            <div className="movie-popup">
                ...
                <div className="movie-details">
                    <h2 className="movie-title">{details.name}</h2>
